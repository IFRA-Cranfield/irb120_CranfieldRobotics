...
For more detailed instructions on how to properly set up any ABB Robot for ROS 2 and to connect to the ABB IRB-120 robot, please visit the ros2_SimRealRobotControl documentation. Once that is ready, you can execute the following command to launch the ABB's ROS 2 driver along with MoveIt!2, and our custom ROS 2 tools for robot operation:
