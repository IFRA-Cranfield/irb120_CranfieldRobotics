...
```sh
cd ~/dev_ws/src
git clone -b jazzy https://github.com/IFRA-Cranfield/irb120_CranfieldRobotics
cd ~/dev_ws
colcon build
```
...
python3 "$HOME/dev_ws/src/irb120_CranfieldRobotics/irb120cranfield_ope/python/PositionEstimation.py" environment:=gazebo model:=ColouredCubes_irb120 visualize:=true
```

This is the supported workflow for the `irb120cranfield_ope` perception node in Ubuntu 24.04 + ROS 2 Jazzy.
